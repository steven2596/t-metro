        ...
        <nav className="navbar" >
            ...
            <ul className="navbar__right" >
                ...
                </li>
                {
                    currentUser ?
                        <li className="navbar__item" >
                            <svg className="navbar__icon navbar__icon--user" onClick={() => signOutStart()}>
                ...
                <li className="navbar__item" >
                    <svg className="navbar__icon navbar__icon--cart" onClick={() => setDropdown(!dropdown)}>
            ...
            <NavigationMenu setDropdown={setDropdown} currentUser={currentUser} signOutStart={signOutStart} />
